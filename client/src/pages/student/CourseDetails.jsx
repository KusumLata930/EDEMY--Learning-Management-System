...
const toggleSection=(index)=>{
  ...
  return courseData? (
  <>
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 
    pt-20 text-left'>
      ...
      {/*right column */}
      <div className='max-w-course-card z-10 shadow-custom-card round-t md:rounded-none overflow-hidden bg-white
      min-w-[300px] sm:min-w-[420px]'>
        {
              playerData? 
              <YouTube videoId={playerData.videoId} opts={{playerVars:{
                autoplay:1}}} isFrameClassName='w-full aspect-video'/>
